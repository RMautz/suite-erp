    ...
    <main className="mx-auto max-w-6xl">
      <header className="flex items-center justify-between border-b border-slate-100 px-6 py-4 sm:px-10">
        <div className="flex items-center gap-2 font-bold text-slate-900">
          <span className="grid h-7 w-7 place-items-center rounded-lg grad-marca text-sm text-white">
            L
          </span>
          Letier ERP
        </div>
          ...
          <Link
            ...
            className={
              sesion
                ...
                : 'rounded-lg grad-marca px-4 py-2 font-semibold text-white shadow-md shadow-marca-600/30'
            }
          >
            Prueba gratis
          </Link>
          {sesion &&
            (sesion.destino === process.env.NEXT_PUBLIC_URL_ADMIN ? (
              ...
              <details className="relative">
                <summary className="cursor-pointer list-none rounded-lg grad-marca px-4 py-2 font-semibold text-white shadow-md shadow-marca-600/30 [&::-webkit-details-marker]:hidden">
                  Mi cuenta ▾
                </summary>
      ...
      <section className="grad-marca px-6 py-14 text-center text-white">
