    ...
    >
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-marca-100 bg-white p-8 shadow-xl shadow-marca-600/10">
          ...
          <p className="mt-1 text-sm text-slate-500">Elige una contraseña de al menos 8 caracteres.</p>
          <form action={accion} className="mt-6 grid gap-4">
            ...
            <label className="block">
              <span className="mb-1 block text-sm font-medium text-slate-700">Repite la contraseña</span>
              <input name="confirmar" type="password" required minLength={8} autoComplete="new-password" className={CLASES_INPUT} />
            </label>
            {estado.error && (
